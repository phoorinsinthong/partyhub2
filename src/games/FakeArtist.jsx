...
const WORD_CATEGORIES = {
  animals: {
    label: 'สัตว์',
    words: ['แมว', 'หมา', 'ช้าง', 'ยีราฟ', 'เพนกวิน', 'ปลา', 'นก', 'กบ', 'เต่า', 'กระต่าย', 'นกฮูก', 'ปลาฉลาม', 'เป็ด', 'กวาง', 'ผีเสื้อ', 'ม้า', 'ลิง', 'งู', 'แมงมุม', 'โลมา'],
  },
  food: {
    label: 'อาหาร',
    words: ['พิซซ่า', 'แฮมเบอร์เกอร์', 'ซูชิ', 'ไอศกรีม', 'เค้ก', 'แตงโม', 'กล้วย', 'ส้มตำ', 'ข้าวผัด', 'ก๋วยเตี๋ยว', 'ฮอทดอก', 'โดนัท', 'ข้าวปั้น', 'ชาไข่มุก', 'ป๊อปคอร์น'],
  },
  places: {
    label: 'สถานที่',
    words: ['บ้าน', 'ภูเขา', 'ทะเล', 'ปราสาท', 'สะพาน', 'โรงเรียน', 'สนามบิน', 'สวนสนุก', 'ชายหาด', 'น้ำตก', 'วัด', 'ห้างสรรพสินค้า', 'ถ้ำ', 'เกาะ', 'สวนสัตว์'],
  },
  objects: {
    label: 'สิ่งของ',
    words: ['ร่ม', 'จักรยาน', 'กล้อง', 'นาฬิกา', 'หมวก', 'แว่นตา', 'โทรศัพท์', 'กีตาร์', 'กระเป๋า', 'รองเท้า', 'ตุ๊กตาหมี', 'เตียง', 'ตู้เย็น', 'แว่นกันแดด', 'กระบองเพชร'],
  },
  vehicles: {
    label: 'ยานพาหนะ',
    words: ['รถ', 'เรือ', 'เครื่องบิน', 'จรวด', 'เรือดำน้ำ', 'รถไฟ', 'จักรยาน', 'เฮลิคอปเตอร์', 'รถบัส', 'เรือใบ', 'สเก็ตบอร์ด', 'รถแข่ง', 'บอลลูน', 'รถตุ๊กตุ๊ก', 'รถมอเตอร์ไซค์'],
  },
  fantasy: {
    label: 'แฟนตาซี',
    words: ['มังกร', 'หุ่นยนต์', 'ยูนิคอร์น', 'มงกุฎ', 'ดาบ', 'เงือก', 'พ่อมด', 'ซุปเปอร์ฮีโร่', 'ปราสาท', 'นินจา', 'เจ้าหญิง', 'อัศวิน', 'ซอมบี้', 'แวมไพร์', 'หุ่นยนต์ยักษ์'],
  },
};
