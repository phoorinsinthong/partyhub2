...
const ROLES = {
  ...
  insomniac: { name: "คนนอนไม่หลับ", icon: " Owls", team: "villager", color: "#6b7280", actionPhase: "nightly", actionType: "none", description: "ตื่นกลางคืนเพื่อดูว่าใครลุกจากเตียงบ้าง (ทำ Activity กลางคืน)" },
